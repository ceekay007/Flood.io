...
public class NavigationFlow  {
    ...
    /* Create a new instance of the html unit driver
       ...
       not the implementation. */
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Study\\Automation\\chromedriver_win32\\chromedriver.exe");
        ...
        while( iterations < 2 ) {
            try {
                ...
                //country
                Select lstCountry = new Select(driver.findElement(By.xpath("//select[contains(@name, 'billing_country')]")));
                lstCountry.selectByVisibleText("United States (US)");

                //street address
                driver.findElement(By.xpath("//input[contains(@name, 'billing_address_1')]")).sendKeys("100 Performance Way");

                //town / city
                driver.findElement(By.xpath("//input[contains(@name, 'billing_city')]")).sendKeys("Loadville");

                //state
                Select lstState = new Select(driver.findElement(By.xpath("//select[contains(@name, 'billing_state')]")));
                lstState.selectByVisibleText("California");
                //driver.findElement(By.xpath("//select[contains(@name, 'billing_state')]")).selectByVisibleText("California");
